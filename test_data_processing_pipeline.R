...
test_data$item_description<-sapply(test_data$item_description,remove_punctuation)
...
test_dummy_condition<-test_dummy_condition[,-1]
...
save(model_test_data,file="processed_data/model_test_data.RData")
rm(test_dummy_condition,test_dummy_main_cate,test_dummy_sub_cate,test_split_categ)
rm(test_brand_missing,test_desc_length,test_log_length)
...
final_name_test_8<-sparseMatrixPredict(dtm_test_name_tfidf,final_name_encoder,batch_size=1024,3460725)
save(final_name_test_8,file="processed_data/final_name_test_8.RData")
rm(dtm_test_name,dtm_test_name_tfidf)
...
final_brand_test_8<-sparseMatrixPredict(dtm_test_brand_tfidf,final_brand_encoder,batch_size=1024,3460725)
save(final_brand_test_8,file="processed_data/final_brand_test_8.RData")
rm(dtm_test_brand,dtm_test_brand_tfidf)
...
final_cate_test_8<-sparseMatrixPredict(dtm_test_cate_tfidf,final_cate_encoder,batch_size=1024,3460725)
save(final_cate_test_8,file="processed_data/final_cate_test_8.RData")
rm(dtm_test_cate,dtm_test_cate_tfidf)
...
final_desc_test_32<-sparseMatrixPredict(dtm_test_desc_tfidf,final_desc_encoder,batch_size=1024,3460725)

model_test_data<-as.matrix(model_test_data)
final_test_data<-cbind(model_test_data,final_brand_test_8,final_cate_test_8,final_name_test_8,final_desc_test_32)
final_test_data<-as.matrix(final_test_data)
save(final_test_data,file="processed_data/final_test_data.RData")
rm(dtm_test_desc,dtm_test_desc_tfidf,final_brand_test_8,final_cate_test_8,final_desc_test_32,final_name_test_8)
...
rm(final_test_data,logical_test_data)
...
load("processed_data/stem_feature/stem_brand_tfidf.RData")
load("processed_data/stem_feature/stem_cate_tfidf.RData")
load("processed_data/stem_feature/stem_desc_tfidf.RData")
load("processed_data/stem_feature/stem_name_tfidf.RData")
load("processed_data/stem_feature/stem_brand_vectorizer.RData")
load("processed_data/stem_feature/stem_cate_vectorizer.RData")
load("processed_data/stem_feature/stem_desc_vectorizer.RData")
load("processed_data/stem_feature/stem_name_vectorizer.RData")
stemming<-function(x){
...
stem_name_test_8<-sparseMatrixPredict(test_stem_name_tfidf,stem_name_encoder,batch_size=1024,3460725)
save(stem_name_test_8,file="processed_data/stem_name_test_8.RData")
rm(dtm_test_stem_name,test_stem_name_tfidf)
...
tok_fun = space_tokenizer
#name_iterator
it_brand= itoken(test_data_brand_stem, 
                preprocessor = prep_fun, 
                tokenizer = tok_fun, 
                ids = test_data$test_id, 
                progressbar = FALSE)
...
stem_brand_test_8<-sparseMatrixPredict(test_stem_brand_tfidf,stem_brand_encoder,batch_size=1024,3460725)
save(stem_brand_test_8,file="processed_data/stem_brand_test_8.RData")
rm(dtm_test_stem_brand,test_stem_brand_tfidf)
...
stem_desc_test_32<-sparseMatrixPredict(test_stem_desc_tfidf,stem_desc_encoder,batch_size=1024,3460725)
save(stem_desc_test_32,file="processed_data/stem_desc_test_32.RData")
rm(dtm_test_stem_desc,test_stem_desc_tfidf)
